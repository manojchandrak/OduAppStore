...
<div class="mdl-textfield mdl-js-textfield" style="text-align:"center"">
    <textarea class="mdl-textfield__input" type="text" rows= "3" id="reviewArea" name="reviewText" style="width:600px;display: block;margin-left: auto;margin-right: auto;"></textarea>
